...
document.addEventListener('DOMContentLoaded', () => {
    ...
    chrome.storage.local.get(['capturedImage', 'captureTime'], (result) => {
    ...
    function startCapture() {
        ...
        chrome.runtime.sendMessage({ action: 'initiateCapture' }, (response) => {
            hideLoading();
    ...
    function resetToCapture() {
        ...
        // Clear storage
        chrome.storage.local.remove(['capturedImage', 'captureTime']);
    }
